...
__webpack_require__(/*! ./mod */ "./src/test-webpack/mod.ts");
...
function checkEqualPasswords(password, password2) {
    if (password.value !== password2.value) {
        showErrorMessage(password2, "As senhas não estão iguais");
    }
}
...
function checkForEmptyFields(...inputs) {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMessage(input, "Preenchimento obrigatório");
    });
}
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/test-webpack/index.ts");
/******/ 	
/******/ })()
;
